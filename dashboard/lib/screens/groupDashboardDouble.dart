...
class GroupDashboardDouble extends StatefulWidget {
  final int currentgroupID;

  GroupDashboardDouble({Key key, this.currentgroupID}) : super(key: key);

  @override
  GroupDashboardDoubleState createState() => GroupDashboardDoubleState();
}

class GroupDashboardDoubleState extends State<GroupDashboardDouble> {
  ...
  double screenSizeWidth = 450;
  double screenSizeHeight = 450;
                        ...
                        child: Row(children: [
                          ...
                          Padding(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String newValue) {
                                  setState(() {
                                    groupID2 = int.parse(newValue) - 1;
                                  });

                                  thisClass.getPosition(
                                      groupID2, activityID2, turnID2, trialID2);
                                },
                                items: <String>[
                                  '',
                                  '1',
                                    ...
                                    children: <Widget>[
                                      Row(children: [
                                        ...
                                        Slider(
                                            ...
                                            value: _currentCelluloSliderValue[
                                                groupID],
                                            min: 0.05,
                                            max: 0.95,
                                            // divisions: 5,
                                                        ...
                                                        child: Padding(
                                                            ...
                                                            child: Card(
                                                                ...
                                                                child: ListTile(
                                                                  title: Text(
                                                                    "Mean Error: " +
                                                                        double.parse((thisClass.groups[groupID].activities[activityID].turns[turnID].error).toStringAsFixed(1))
                                                                            .toString(),
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight
                                                        ...
                                                        child: Padding(
                                                            ...
                                                            child: Card(
                                                                ...
                                                                child: ListTile(
                                                                  title: Text(
                                                                    "Mean Error: " +
                                                                        double.parse((thisClass.groups[groupID2].activities[activityID2].turns[turnID2].error).toStringAsFixed(1))
                                                                            .toString(),
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight
