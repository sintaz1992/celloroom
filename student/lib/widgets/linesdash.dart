            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                  ...
                  child: Image.asset("assets/images/Ac7_function1.png",
                      ...
                      width: student.playgroundheight / 8)),
              SizedBox(height: 15 / 500 * student.playgroundheight),
              student.acgame6.linesstatus[1] == 0
                  ? Text('')
                  : (student.acgame6.linesstatus[1] == 1
                      ? Image.asset("assets/images/right.jpg",
                          height: 75 * student.playgroundheight / 860,
                          width: student.playgroundheight / 10)
                      : Image.asset("assets/images/right.jpg",
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                  ...
                  child: Image.asset("assets/images/Ac7_function1.png",
                      ...
                      width: student.playgroundheight / 8)),
              SizedBox(height: 15 / 500 * student.playgroundheight),
              student.acgame6.linesstatus[2] == 0
                  ? Text('')
                  : (student.acgame6.linesstatus[2] == 1
                      ? Image.asset("assets/images/right.jpg",
                          height: 75 * student.playgroundheight / 860,
                          width: student.playgroundheight / 10)
                      : Image.asset("assets/images/right.jpg",
