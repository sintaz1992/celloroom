...
class _Ac4State extends State<Ac4> with TickerProviderStateMixin {
...
//Activity Dependent
  ...
  void initState() {
    ...
    student.starttimer[3] = student.elapseTimer.elapsedMilliseconds;

    timerCelluloPosition =
        new Timer.periodic(new Duration(milliseconds: 200), (time) {
      if (student.currentActivity == 'Ac4') {
        student.acgame4.checkCelluloGame();
      }
    });

    if (student.groupPolicy2[student.role - 1][student.groupCurrentTurn - 1] ==
        'T') {
      student.acgame4.timerColorButton =
          new Timer.periodic(new Duration(milliseconds: 2000), (time) {
        if (student.acgame4.startButtonColor == Colors.grey) {
          student.acgame4.startButtonColor = Colors.orange;
          //  student.acgame4.notifyListeners();
        } else {
          student.acgame4.startButtonColor = Colors.grey;
          //student.acgame4.notifyListeners();
        }
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    student.acgame4.targetSet(student.acgame4.setx, student.acgame4.sety);
        ...
        appBar: AppBar(
          ...
          title: Text(
              (student.currentActivity == 'Ac4')
                  ? AppTranslations.of(context).text("ac4_appbar")
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                            ...
                                                                            child: Center(
                                                                              ...
                                                                              child: Text(student.acgame4.instructionText, textAlign: TextAlign.center, style: student.titletext),
                                                                            ))),
                                                                        SizedBox(
                                                                            height: 10 /
                                                                                500 *
