...
class Ac3t extends StatefulWidget {
  Ac3t({Key key}) : super(key: key);

  @override
  _Ac3tState createState() => _Ac3tState();
}

class _Ac3tState extends State<Ac3t> with TickerProviderStateMixin {
            ...
            await FirebaseFirestore.instance
                ...
                .then((value) => {
                      for (int i = 0; i < value.size; i++)
                        {
                          if (value.docs.elementAt(i).get('readTutAc3t') ==
                              true)
                            {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppTranslations.of(context).text("ac3t_appbar"),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                            ...
                                            child: (page == 1)
                                                ? Image.asset(
                                                    (student.curLang == 'en')
                                                        ? 'assets/images/master33.png'
                                                        : (student.curLang ==
                                                                'fa')
                                                            ? 'assets/images/faac3.png'
                                                            : 'assets/images/master33f.png',
