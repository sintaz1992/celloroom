...
class _Ac9State extends State<Ac9> with TickerProviderStateMixin {
...
//Activity Dependent
  ...
  void initState() {
    ...
    student.starttimer[8] = student.elapseTimer.elapsedMilliseconds;

    student.acgame9.timerColorButton =
        new Timer.periodic(new Duration(milliseconds: 2000), (time) {
      if (student.acgame9.startButtonColor == Colors.grey) {
        student.acgame9.startButtonColor = Colors.orange;
        //  student.acgame4.notifyListeners();
      } else {
        student.acgame9.startButtonColor = Colors.grey;
        //student.acgame4.notifyListeners();
      }
    });
        ...
        appBar: AppBar(
          ...
          title: Text(
              (student.currentActivity == 'Ac9')
                  ? AppTranslations.of(context).text("ac9_appbar")
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                            ...
                                                                            child: Center(
                                                                              ...
                                                                              child: Text(student.acgame9.instructionText, textAlign: TextAlign.center, style: student.titletext),
                                                                            ))),
                                                                        SizedBox(
                                                                            height: 10 /
                                                                                500 *
