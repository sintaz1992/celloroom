...
class Game6 extends ChangeNotifier {
...
// checkcellulorles
  ...
  void startgameposition() {
    clearPosition(currenttrial, 6);
    student.acgame6.showinstructionT = true;
    student.acgame6.instructionText =
    ...
    checkinitialposition =
      ...
      if ((checkstartgame(student.cellulox.x, student.celluloy.y))) {
        ...
        startGameV = true;
        allowPaint = true;
        student.acgame6.showinstructionT = false;
        student.acgame6.instructionText = '';
        animationvalue = 0.0;
        checkinitialposition.cancel();
        reachendtimer = new Timer.periodic(new Duration(seconds: 10), (time) {
          print('reach');
          if (currenttrial == numtrials - 1) {
            reachend();
            if (score > 100) {
              student.acgame6.linesstatus[currenttrial] = -1;
            } else {
              student.acgame6.linesstatus[currenttrial] = 1;
            }
            ...
            reachendtimer.cancel();
            student.acgame6.newtrial();
            //startGameV = false;
            allowPaint = false;
          }

          if (checkendgame(student.cellulox.x, student.celluloy.y) &&
              startGameV) {}
        });
      }
    });
  ...
  void newtrial() {
    ...
    student.acgame6.currenttrial = student.acgame6.currenttrial + 1;
  ...
  void reachend() {
    ...
    student.acgame6.showinstruction = true;
    student.acgame6.showinstructionT = true;
    instructionText =
        AppTranslations.of(student.navigatorKeygame.currentState.context)
            .text("victoryEnd");
    ...
    student.acgame6.notifyListeners();

    student.activityTime[5] =
        ((student.elapseTimer.elapsedMilliseconds - student.starttimer[5]) /
                1000)
            .round();
  ...
  void funcstartgame() {
    student.acgame6.startgame = true;
    ...
    student.acgame6.tasktext =
        AppTranslations.of(student.navigatorKeygame.currentState.context)
            .text("instruction_followline_ac6");
  ...
  void begingame() {
    ...
    student.acgame6.startgame = false;
    student.reachendV = false;
    startGameV = false;
    student.acgame6.reward = 0;
    student.acgame6.showreport = false;
    // initialposition();
    celluloxPositiontopaint[0] = [0.0, 0.0];
    celluloyPositiontopaint[0] = [0.0, 0.0];
    currenttrial = 0;
