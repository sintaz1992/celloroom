...
class Game9 extends ChangeNotifier {
...
// checkcellulorles
  ...
  void startgameposition() {
    student.acgame9.showinstructionT = true;
    student.acgame9.instructionText =
  ...
  void newtrial() {
    student.velocityx[(student.groupCurrentTurn - 1) * numtrials +
        currenttrial] = velocity[0] * student.mapSizeHeight / limittime;
    student.velocityy[(student.groupCurrentTurn - 1) * numtrials +
        currenttrial] = -velocity[1] * student.mapSizeHeight / limittime;
    ...
    score = 0;
    velocity = [0.0, 0.0];
    student.acgame9.currenttrial = student.acgame9.currenttrial + 1;
    celluloxPositiontopaint[0] = [0.0, 0.0];
    celluloyPositiontopaint[0] = [0.0, 0.0];
    // clearPosition(currenttrial, 9);
    trybuttonshow = false;
  ...
  void reachend() {
    ...
    student.acgame9.showinstruction = true;
    student.acgame9.showinstructionT = true;
    instructionText =
        AppTranslations.of(student.navigatorKeygame.currentState.context)
            .text("victoryEnd");
...
//    print(velocity[0] / limittime);
  ...
  void funcstartgame() {
    student.acgame9.startgame = true;
    ...
    timerCelluloPositionPaint =
      ...
      if (allowPaint == true) {
        ...
        print((student.cellulox.x * 2 - 1) * student.mapSizeHeight / 2 / 66.1);

        print((-student.celluloy.y * 2 + 1) * student.mapSizeHeight / 2 / 66.1);
    ...
    student.acgame9.tasktext =
        AppTranslations.of(student.navigatorKeygame.currentState.context)
            .text("instruction_followline_ac9");
  ...
  void begingame() {
    ...
    student.acgame9.startgame = false;
    student.reachendV = false;
    startGameV = false;
    student.acgame9.reward = 0;
    student.acgame9.showreport = false;
    // initialposition();
    celluloxPositiontopaint[0] = [0.0, 0.0];
    celluloyPositiontopaint[0] = [0.0, 0.0];
    currenttrial = 0;
